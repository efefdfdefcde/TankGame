...
namespace Assets.Scripts.New.Shop.Upgrades
{
    public  class UpgradeView : MonoBehaviour 
    {
        ...
        public void Init(NationStorage data)
        {
            _data = data;
            New.Arhitecture.EventBus.Instance._spawnPopup.Subscribe(_ => DestroyPop()).AddTo(_disposables);
        }
        ...
        {
            New.Arhitecture.EventBus.Instance._spawnPopup.OnNext(Unit.Default);
